...
e.src=d;return e};SearchShortcut.geoMap={US:{code:"",noResults:"No suggestions found. Search all of apple.com.",viewAll:"View all search results",shortcuts:"Recommended Results",suggestionsText:"Common Searches",searchText:"Search"},AE:{code:"ae"},ASIA:{code:"asia"},AT:{code:"at",noResults:"Kein Treffer in Kurzsuche. Vollsuche auf apple.com",viewAll:"Alle Suchergebnisse",searchText:"Suchen"},AU:{code:"au"},BE_FR:{code:"bf",noResults:"Pas de rÃ©sultat. Essayez une recherche apple.com",viewAll:"Afficher tous les rÃ©sultats",shortcuts:"Raccourcis",searchText:"Rechercher"},BE_NL:{code:"bl",noResults:"Niets gevonden. Zoek opnieuw binnen www.apple.com.",viewAll:"Toon alle zoekresultaten",shortcuts:"Snelkoppelingen",searchText:"Zoek"},BR:{code:"br",noResults:"NÃ£o encontrado. Tente a busca em apple.com",viewAll:"Ver todos os resultados da busca",shortcuts:"Links rapidos",searchText:"Buscar"},CA_EN:{code:"ca",directory:"/ca"},CA_FR:{code:"ca",directory:"/ca/fr",viewAll:"Afficher tous les rÃ©sultats",shortcuts:"Raccourcis",searchText:"Recherche"},CH_DE:{code:"ce",noResults:"Kein Treffer in Kurzsuche. Vollsuche auf apple.com",viewAll:"Alle Suchergebnisse",searchText:"Suchen"},CH_FR:{code:"cr",noResults:"Pas de rÃ©sultat. Essayez une recherche apple.com",viewAll:"Afficher tous les rÃ©sultats",shortcuts:"Raccourcis",searchText:"Rechercher"},CN:{code:"cn",directory:"/cn",noResults:"æ‰¾ä¸åˆ°å¿«é€Ÿæœç´¢ç»“æžœï¼Œè¯·å°è¯• apple.com çš„å®Œæ•´æœç´¢",shortcuts:"å¿«é€Ÿé“¾æŽ¥",viewAll:"æŸ¥çœ‹æ‰€æœ‰æœç´¢ç»“æžœ",searchText:"æœç´¢"},DE:{code:"de",viewAll:"Alle Suchergebnisse",noResults:"Kein Treffer in Kurzsuche. Vollsuche auf apple.com",searchText:"Suchen"},DK:{code:"dk",noResults:"Ingen genvej fundet. PrÃ¸v at sÃ¸ge pÃ¥ hele apple.com.",viewAll:"Vis alle sÃ¸geresultater",shortcuts:"Hurtige henvisninger",searchText:"SÃ¸g"},ES:{code:"es",noResults:"NingÃºn atajo. BÃºsqueda completa en apple.com",viewAll:"Ver todos los resultados de bÃºsqueda",shortcuts:"Enlaces rÃ¡pidos",searchText:"Buscar"},FI:{code:"fi",noResults:"Ei oikotietÃ¤. Etsi koko apple.com.",viewAll:"Katso hakutulokset",shortcuts:"Pikalinkit",searchText:"Etsi"},FR:{code:"fr",noResults:"Pas de rÃ©sultat. Essayez une recherche apple.com",viewAll:"Afficher tous les rÃ©sultats",shortcuts:"Raccourcis",searchText:"Rechercher"},HK:{code:"hk",noResults:"æ‰¾ä¸åˆ°å¿«é€Ÿæœå°‹çµæžœï¼Œè«‹è©¦è©¦ apple.com çš„å®Œæ•´æœå°‹",viewAll:"æª¢è¦–æ‰€æœ‰æœå°‹çµæžœ",shortcuts:"å¿«é€Ÿé€£çµ",searchText:"æœå°‹"},HK_EN:{code:"hk",directory:"/hk/en"},ID:{code:"id"},IE:{code:"ie"},IN:{code:"in"},IT:{code:"it",noResults:"Nessuna scorciatoia trovata. Provate su apple.com",viewAll:"Mostra tutti i risultati",shortcuts:"Collegamenti rapidi",searchText:"Cerca"},JP:{code:"jp",noResults:"ã‚·ãƒ§ãƒ¼ãƒˆã‚«ãƒƒãƒˆã¯è¦‹ã¤ã‹ã‚Šã¾ã›ã‚“ã§ã—ãŸã€‚æ¤œç´¢ã¯ã“ã¡ã‚‰ã€‚",viewAll:"ã™ã¹ã¦ã®æ¤œç´¢çµæžœã‚’è¦‹ã‚‹",shortcuts:"ã‚¯ã‚¤ãƒƒã‚¯ãƒªãƒ³ã‚¯",searchText:"Search"},KR:{code:"kr",noResults:"ì¼ì¹˜í•˜ëŠ” ê²€ìƒ‰ê²°ê³¼ê°€ ì—†ìŠµë‹ˆë‹¤. ë‹¤ì‹œ ê²€ìƒ‰í•˜ê¸°.",shortcuts:"ë¹ ë¥¸ ì—°ê²°",viewAll:"ê²€ìƒ‰ ê²°ê³¼ ì „ì²´ ë³´ê¸°."},LA:{code:"la",noResults:"No se encontraron resultados. Intenta en apple.com.",viewAll:"Ver todos los resultados de la bÃºsqueda",shortcuts:"Enlaces rÃ¡pidos",searchText:"Buscar"},LAE:{code:"lae",noResults:"No shortcut found. Search all of apple.com.",viewAll:"View all search results",searchText:"Search"},MX:{code:"mx",noResults:"No se encontraron resultados. Intenta en apple.com.",viewAll:"Ver todos los resultados de la bÃºsqueda",shortcuts:"Enlaces rÃ¡pidos",searchText:"Buscar"},MY:{code:"my"},NL:{code:"nl",noResults:"Niets gevonden. Zoek opnieuw binnen www.apple.com.",viewAll:"Toon alle zoekresultaten",shortcuts:"Snelkoppelingen",searchText:"Zoek"},NO:{code:"no",noResults:"Fant ingen snarvei. SÃ¸k pÃ¥ hele apple.com.",viewAll:"Vis alle sÃ¸keresultater",shortcuts:"Hurtigkoblinger",searchText:"SÃ¸k"},NZ:{code:"nz"},PH:{code:"ph"},PL:{code:"pl",noResults:"Fraza nie zostaÅ‚a odnaleziona. UÅ¼yj apple.com.",viewAll:"PrzeglÄ…daj wszystkie wyniki",shortcuts:"PodrÄ™czne Å‚Ä…cza",searchText:"Szukaj"},PT:{code:"pt",noResults:"Nenhum resultado. Tente pesquisar em apple.com.",viewAll:"Ver todos os resultados de pesquisa",shortcuts:"LigaÃ§Ãµes rÃ¡pidas",searchText:"Procurar"},RU:{code:"ru",noResults:"Ð¡ÑÑ‹Ð»Ð¾Ðº Ð½ÐµÑ‚. ÐŸÐ¾Ð¿Ñ€Ð¾Ð±ÑƒÐ¹Ñ‚Ðµ Ñ€Ð°ÑÑˆÐ¸Ñ€ÐµÐ½Ð½Ñ‹Ð¹ Ð¿Ð¾Ð¸ÑÐº.",viewAll:"ÐŸÐ¾ÐºÐ°Ð·Ð°Ñ‚ÑŒ Ð²ÑÐµ Ñ€ÐµÐ·ÑƒÐ»ÑŒÑ‚Ð°Ñ‚Ñ‹ Ð¿Ð¾Ð¸ÑÐºÐ°",shortcuts:"Ð‘Ñ‹ÑÑ‚Ñ€Ñ‹Ðµ ÑÑÑ‹Ð»ÐºÐ¸",searchText:"ÐŸÐ¾Ð¸ÑÐº"},SA:{code:"sa"},SE:{code:"se",noResults:"Ingen genvÃ¤g hittad. SÃ¶k i hela apple.com.",viewAll:"Visa alla sÃ¶kresultat",shortcuts:"SnabblÃ¤nkar",searchText:"SÃ¶k"},SG:{code:"sg"},TH:{code:"th"},TR:{code:"tr",noResults:"Ã–neri bulunamadÄ±. TÃ¼m apple.com'da ara.",viewAll:"TÃ¼m arama sonuÃ§larÄ±nÄ± gÃ¶ster",shortcuts:"Ã–nerilen SonuÃ§lar",searchText:"Arama"},TW:{code:"tw",noResults:"å¿«é€Ÿæœå°‹æ‰¾ä¸åˆ°ï¼Œè©¦è©¦ apple.com å®Œæ•´æœå°‹",viewAll:"ç€è¦½æœç´¢çµæžœ",shortcuts:"å¿«é€Ÿé€£çµ",searchText:"æœå°‹"},UK:{code:"uk"},VN:{code:"vn"},ZA:{code:"za"},PO:null,UA:null,RO:null,CZ:null,HU:null,BG:null,HR:null,GR:null,IS:null};
